#Obtaining Figure 2.5. Fitting a smooth loess. It requires the csv file that can be also found in this repository
...
z=Income3D$Income
fit.loess<-loess(z~x+y+x*y,span=0.4,degree=2)
